...
import { App, Button, Card, Divider, Flex, Input, Space, Typography, Skeleton, Segmented, InputNumber, Tooltip } from 'antd'
                ...
                <Card key={it.股票代码} size="small" title={`${it.股票名称} (${it.股票代码})`}>
                  <Space direction="vertical" size={6} style={{ width: '100%' }}>
                    <Flex gap={8} wrap align="center">
                      ...
                      <Tooltip title="AI 给出的分析信心，范围 0-10"><span>AI信心：<b>{fmt2((it as any)?.AI信心)}</b></span></Tooltip>
                      <Tooltip title="融合分 = 技术分 与 AI信心 的加权融合，范围 0-10"><span>融合分：<b>{fmt2((it as any)?.融合分)}</b></span></Tooltip>
                    </Flex>
